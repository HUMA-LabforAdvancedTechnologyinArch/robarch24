...
arucoDictionaryIdFromString(const std::string &idString) {
  ...
  PARSE_PREDEFINED_ARUCO_DICTIONARY_ID(DICT_7X7_50)
  PARSE_PREDEFINED_ARUCO_DICTIONARY_ID(DICT_7X7_100)
  PARSE_PREDEFINED_ARUCO_DICTIONARY_ID(DICT_7X7_250)
  PARSE_PREDEFINED_ARUCO_DICTIONARY_ID(DICT_7X7_1000)
